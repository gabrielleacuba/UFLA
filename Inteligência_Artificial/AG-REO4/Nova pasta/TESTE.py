...
class AlgoritmoGenetico():
    ...
    #Algoritmo genético para encontrar o x para o qual a função x*x - 3x + 4 assume o valor máximo
    ...
    def selecionar(self):
        #Realiza a seleção do individuo mais apto por torneio, considerando N = 2 (participantes)
    ...
    def crossover(self, pai, mae):
        ...
        if randint(1,100) <= self.taxa_crossover:
            ...
            self.ajustar(filho_1)
            self.ajustar(filho_2)    
        else:
...
def main():
    ...
    algoritmo_genetico = AlgoritmoGenetico(-10, 10, 4, 1, 70, 5)
    ...
    for i in range(algoritmo_genetico.num_geracoes):
        ...
        print( 'Resultado {}: {}'.format(i, algoritmo_genetico.encontrar_mais_apto()) )
    ...
    print( 'Resultado {}: {}'.format(i+1, algoritmo_genetico.encontrar_mais_apto()) )
